...
import numpy as np
import dlib
chris = face_recognition.load_image_file('assignment\chris.jpg')
chris_encodings = face_recognition.face_encodings(chris)[0]
robert = face_recognition.load_image_file('assignment\robert.jpg')
...
while cap.isOpened():
    ...
    rgb_small__frame = cv2.cvtColor(small_frame,cv2.COLOR_BGR2RGB)
